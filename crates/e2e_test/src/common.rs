...
pub const RUSTFS_BINARY_PATH: &str = "/Users/dandan/code/rust/rustfs_kms/target/debug/rustfs";
...
impl RustFSTestEnvironment {
    ...
    pub async fn start_rustfs_server(&mut self, extra_args: Vec<&str>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        ...
        let process = Command::new(RUSTFS_BINARY_PATH).args(&args).spawn()?;
...
pub async fn execute_awscurl(
    ...
    const AWSCURL_PATH: &str = "/Users/dandan/Library/Python/3.9/bin/awscurl";
